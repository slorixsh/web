...
export default function Header() {
    ...
    return <>
        ...
        <div style={{ zIndex: 99 }} id="header-slorixsh" className={`${scrolled?.currentScrollHeight > 70 && '!py-4 shadow-xl bg-white'} fixed px-6 lg:px-36 py-12 w-full transition-all duration-200`}>
            <div className="lg:grid lg:grid-cols-12 flex justify-between items-center w-full">
                <div className="col-span-3 w-full">
                    <Link href="/">
                        <p className="cursor-pointer font-semibold text-2xl">slorixsh<span className="text-cIndigo">.</span></p>
                    </Link>
                </div>
